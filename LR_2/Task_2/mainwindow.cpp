...
void MainWindow::on_pushButton_add_trip_clicked()
{
    ...
    if(resultOfAddInformation > 0) {
        ...
        if (resultOfAddInformation == 1) showInformationEvent("Информация успешно обновлена");
        else if (resultOfAddInformation == 2) showInformationEvent("Информация успешно добавлена");
    }
    else {
